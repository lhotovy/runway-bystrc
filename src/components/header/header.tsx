...
export const Header = () => {
  ...
  return (
    <div className="flex justify-center items-center ">
      ...
      <div className="flex mx-auto items-center pl-6 py-4 md:w-1/2 w-full justify-between absolute top-10">
        <Link 
        ...
        <button 
          ...
          className="absolute r-0 p-2 w-10 h-10 mx-2 text-sm text-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600" 
      ...
      <div 
      className={`${expanded} w-full fixed top-20`} 
      id="navbar-hamburger"
      >
