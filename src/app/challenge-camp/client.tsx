...
export const ChallengeCampClient = () => {
    ...
    return (
        ...
        <div className="w-[calc(100vw-15px)] bg-gray-1 flex flex-col items-center mt-10 py-6">
            <div className="max-w-[1280px] flex flex-col justify-start items-start py-7.5  gap-y-8">
        ...
        <div className="flex justify-center w-full py-12">            
            <div className="flex w-full items-center justify-center gap-x-48">
        ...
        <div className="w-[calc(100vw-15px)] bg-blue-5 py-16">
            <p className="text-xl font-bold text-white w-[850px] mx-auto mb-8">Program dne</p>
            <div className="grid grid-cols-6 w-[850px] mx-auto text-white">             
                <div className="font-semibold w-24 flex flex-col gap-y-3">
                    <p>7:30 - 8:00</p>
                    <p>8:00 - 9:00</p>
                    <p>9:10 - 10:10</p>
                    <p>10:15 - 10:30</p>
        ...
        <div className="flex flex-col items-center mt-10">
            <p className="text-xl italic w-96">
                “Chtěla bych poděkovat všem, kteří se podíleli na organizaci tábora. Perfect camp.”
            </p>
            <h2 className="text-[32px] font-bold mt-16">Minulé tábory</h2>
            <iframe 
                width="1280" 
                height="700" 
