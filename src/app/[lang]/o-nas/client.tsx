...
export const ONasClient = ({ lang }: { lang: 'cs' | 'en' }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full">    
      ...
      <div className="flex flex-col items-center mt-24 w-full bg-blue-1 px-4 md:px-0">
      ...
      {/* contact */}
      <div className="w-full flex justify-center bg-content-blue py-7.5 px-4 md:px-0">
      ...
      <div className="w-full flex justify-center bg-jasmin py-12 px-4 md:px-0">
        <div className="flex flex-col items-center gap-y-4 w-full max-w-screen-xl px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-y-12 sm:gap-x-8 w-full md:w-4/5 max-w-screen-xl">
