...
export async function generateMetadata(
    ...
    const data = tabory.translations[lang];   
    ...
    return (
        ...
        <div className="hidden lg:flex items-center w-full">
            <div className="w-2/3 flex flex-col justify-start gap-y-10">
                <h1 className="text-5xl text-gray-9 font-semibold">{texts.title}</h1>
                <p className="text-gray-9 text-base flex flex-col items-start gap-y-8">
                    {texts.description}
                </p>          
            </div>
            <div className="w-1/3 flex justify-center">
                <Image src="/camps.webp" alt="{texts.title}" width={300} height={300} className="w-60 h-60 rounded-2xl" />
            </div>
        </div>  
        ...
        <div className="flex lg:hidden items-center w-full">
            <div className="w-full flex flex-col justify-start gap-y-10">
                ...
                <div className="w-full flex justify-center">
                    <Image src="/camps.webp" alt="{texts.title}" width={300} height={300} className="w-80 h-80 rounded-2xl" />
                </div>
                <p className="text-gray-9 text-base flex flex-col items-start gap-y-8">
                    {texts.description}
                </p>          
