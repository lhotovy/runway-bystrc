export const menuTexts = {
    cs: {
        ...
        activitiesDropdown: [
            ...
            { name: "Dramatický klub", url: "/dramaticky-klub" },
    ...
    en: {
        ...
        activitiesDropdown: [
            ...
            { name: "Sport Challenge", url: "/en/sport-challenge" },
            { name: "Runway Youth", url: "/en/runway_youth" },
            { name: "Moms Club", url: "/en/klub-pro-maminky-s-detmi" },
            { name: "English Evenings", url: "/en/english" },
            { name: "Drama Club", url: "/en/dramaticky-klub" },
